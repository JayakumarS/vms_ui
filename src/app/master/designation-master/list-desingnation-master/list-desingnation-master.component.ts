...
displayedColumns = [
  ...
  editCall(row) {
    var encrypted = this.EncrDecr.set(this.serverUrl.secretKey, row.desgnCode);
    this.router.navigate(['/master/designation-Master/add-designation/', encrypted]);
  }
  viewCall(row) {
    var encrypted = this.EncrDecr.set(this.serverUrl.secretKey, row.desgnCode);
    this.router.navigate(['/master/designation-Master/view-designation/', encrypted]);
  }
  ...
  deleteItem(row){
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((data) => {
      ...
      if (data.data == true) {
        ...
        this.spinner.show();
        this.designationMasterService.DeleteDesignationMaster(this.id).subscribe({
          next: (data) => {
            this.spinner.hide();
            if (data.success) {
              this.loadData();
