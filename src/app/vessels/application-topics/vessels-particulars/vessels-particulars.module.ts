...
import { VesselsParticularsRoutingModule } from './vessels-particulars-routing.module';
...
@NgModule({
  declarations: [
    AddVesselsParticularsComponent,
    ListVesselsParticularsComponent
  ],
  imports: [
    CommonModule,
    VesselsParticularsRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class VesselsParticularsModule { }
