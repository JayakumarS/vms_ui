...
import { VesselParticularsRoutingModule } from './vessel-particulars-routing.module';
...
@NgModule({
  declarations: [
    AddVesselParticularsComponent,
    ListVesselParticularsComponent,
    ViewVesselParticularsComponent
  ],
  providers:[
    AddVesselParticularsComponent
  ],
  imports: [
    CommonModule,
    VesselParticularsRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class VesselParticularsModule { }
