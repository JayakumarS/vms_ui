...
import { VesselsDetailsRoutingModule } from './vessels-details-routing.module';
...
@NgModule({
  declarations: [
    ListVesselsDetailsComponent,
  ],
  imports: [
    CommonModule,
    VesselsDetailsRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class VesselsDetailsModule { }
