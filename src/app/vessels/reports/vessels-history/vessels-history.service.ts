...
export class VesselsHistoryService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<VesselsHistory[]> = new BehaviorSubject<VesselsHistory[]>(
    []
  );
