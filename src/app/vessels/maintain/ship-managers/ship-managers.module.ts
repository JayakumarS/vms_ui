...
import { ShipManagersRoutingModule } from './ship-managers-routing.module';
...
@NgModule({
  declarations: [
    ListShipManagersComponent,
    AddShipManagersComponent,
    ViewShipManagersComponent
  ],
  providers:[
    CommonService
  ],
...
export class ShipManagersModule { }
