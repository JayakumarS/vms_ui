...
import { VesselGroupRoutingModule } from './vessel-group-routing.module';
...
@NgModule({
  declarations: [
    AddVesselGroupComponent,
    ListVesselGroupComponent
  ],
  imports: [
    CommonModule,
    VesselGroupRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class VesselGroupModule { }
