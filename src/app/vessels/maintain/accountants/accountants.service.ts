...
export class AccountantsService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<Accountants[]> = new BehaviorSubject<Accountants[]>(
    []
  );
