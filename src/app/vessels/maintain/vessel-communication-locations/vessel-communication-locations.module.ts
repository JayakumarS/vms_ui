...
import { VesselCommunicationLocationsRoutingModule } from './vessel-communication-locations-routing.module';
...
@NgModule({
  declarations: [
    ListVesselCommunicationLocationsComponent,
    AddVesselCommunicationLocationsComponent
  ],
  imports: [
    CommonModule,
    VesselCommunicationLocationsRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class VesselCommunicationLocationsModule { }
