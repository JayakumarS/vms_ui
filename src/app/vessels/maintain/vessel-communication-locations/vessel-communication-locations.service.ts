...
export class VesselCommunicationLocationsService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<VesselCommunicationLocations[]> = new BehaviorSubject<VesselCommunicationLocations[]>(
    []
  );
  ...
  get data(): VesselCommunicationLocations[] {
  ...
  getList() {
    ...
    let list: VesselCommunicationLocations[] = [
      {
        code: "MAS",
