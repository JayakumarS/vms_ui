...
@Component({
  selector: 'app-add-vessel-communication-locations',
  templateUrl: './add-vessel-communication-locations.component.html',
  styleUrls: ['./add-vessel-communication-locations.component.sass']
})
export class AddVesselCommunicationLocationsComponent implements OnInit {
  ...
  docForm: FormGroup;
  payItems: VesselCommunicationLocations;
  currencyList=[];
  edit:boolean=false;
  ...
  constructor(private fb: FormBuilder,
    ...
    public PayItemsService: VesselCommunicationLocationsService,
  ...
  cancel(){
    this.router.navigate(['/vessels/maintain/vessel-communication-locations/list-vessel-communication-locations/']);
  }
