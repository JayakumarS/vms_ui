...
import { IceClassRoutingModule } from './ice-class-routing.module';
...
@NgModule({
  declarations: [
    ListIceClassComponent,
    AddIceClassComponent,
    ViewIceClassComponent
  ],
  providers:[
    CommonService
  ],
