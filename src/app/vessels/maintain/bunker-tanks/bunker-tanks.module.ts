...
import { BunkerTanksRoutingModule } from './bunker-tanks-routing.module';
...
@NgModule({
  declarations: [
    ListBunkerTanksComponent,
    AddBunkerTanksComponent,
    ViewBunkerTanksComponent
  ],
  imports: [
    CommonModule,
    BunkerTanksRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class BunkerTanksModule { }
