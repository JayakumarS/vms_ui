...
export class SeamansContractService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<SeamansContract[]> = new BehaviorSubject<SeamansContract[]>(
    []
  );
