...
export class ExampleDataSource extends DataSource<CurrencyModel> {
  ...
  filteredData: CurrencyModel[] = [];
  renderedData: CurrencyModel[] = [];
  constructor(
  ...
  connect(): Observable<CurrencyModel[]> {
  ...
  sortData(data: CurrencyModel[]): CurrencyModel[] {
