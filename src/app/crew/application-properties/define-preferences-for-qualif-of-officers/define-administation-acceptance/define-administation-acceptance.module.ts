...
import { DefineAdministationAcceptanceRoutingModule } from './define-administation-acceptance-routing.module';
...
@NgModule({
  declarations: [
    ListDefineAdministationAcceptanceComponent,
    AddDefineAdministationAcceptanceComponent
  ],
  imports: [
    CommonModule,
    DefineAdministationAcceptanceRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class DefineAdministationAcceptanceModule { }
