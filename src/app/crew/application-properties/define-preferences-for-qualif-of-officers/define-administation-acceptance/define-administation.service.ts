...
export class DefineAdministationService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<defineadministation[]> = new BehaviorSubject<defineadministation[]>(
    []
  );
