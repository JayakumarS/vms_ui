...
export class DefineQualificationService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<definequalification[]> = new BehaviorSubject<definequalification[]>(
    []
  );
