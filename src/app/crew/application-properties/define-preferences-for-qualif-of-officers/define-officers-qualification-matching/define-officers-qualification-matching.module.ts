...
import { DefineOfficersQualificationMatchingRoutingModule } from './define-officers-qualification-matching-routing.module';
...
@NgModule({
  declarations: [
    ListDefineOfficersQualificationMatchingComponent,
    AddDefineOfficersQualificationMatchingComponent
  ],
  imports: [
    CommonModule,
    DefineOfficersQualificationMatchingRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class DefineOfficersQualificationMatchingModule { }
