...
import { DefineRanksRoutingModule } from './define-ranks-routing.module';
...
@NgModule({
  declarations: [
    AddDefineRanksComponent,
    ListDefineRanksComponent
  ],
  imports: [
    CommonModule,
    DefineRanksRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class DefineRanksModule { }
