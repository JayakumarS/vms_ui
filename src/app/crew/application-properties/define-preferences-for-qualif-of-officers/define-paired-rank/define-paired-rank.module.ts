...
import { DefinePairedRankRoutingModule } from './define-paired-rank-routing.module';
...
@NgModule({
  declarations: [
    AddDefinePairedRankComponent,
    ListDefinePairedRankComponent
  ],
  imports: [
    CommonModule,
    DefinePairedRankRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class DefinePairedRankModule { }
