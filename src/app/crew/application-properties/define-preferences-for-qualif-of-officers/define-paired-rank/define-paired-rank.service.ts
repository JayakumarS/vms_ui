...
export class DefinePairedRankService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<definePairedRank[]> = new BehaviorSubject<definePairedRank[]>(
    []
  );
