...
export class DefineVessalGroupService extends UnsubscribeOnDestroyAdapter{

  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<definevessalgroup[]> = new BehaviorSubject<definevessalgroup[]>(
    []
  );
