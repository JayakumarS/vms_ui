...
import { DefineVessalGroupRoutingModule } from './define-vessal-group-routing.module';
...
@NgModule({
  declarations: [
    AddDefineVessalGroupComponent,
    ListDefineVessalGroupComponent
  ],
  imports: [
    CommonModule,
    DefineVessalGroupRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class DefineVessalGroupModule { }
