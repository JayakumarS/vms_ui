...
import { CrewPayrollCurrencyRoutingModule } from './crew-payroll-currency-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    CrewPayrollCurrencyRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class CrewPayrollCurrencyModule { }
