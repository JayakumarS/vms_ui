...
import { DefineCrewEvaluationCriteriaRoutingModule } from './define-crew-evaluation-criteria-routing.module';


@NgModule({
  declarations: [
    AddDefineCrewEvaluationCriteriaComponent,
    ListDefineCrewEvaluationCriteriaComponent
  ],
  providers:[
    CommonService
  ],
  imports:[
    CommonModule,
    DefineCrewEvaluationCriteriaRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class DefineCrewEvaluationCriteriaModule { }
