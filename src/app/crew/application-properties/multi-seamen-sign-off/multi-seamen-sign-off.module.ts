...
import { MultiSeamenSignOffRoutingModule } from './multi-seamen-sign-off-routing.module';
...
@NgModule({
  declarations: [
    AddMultiSeamenSignOffComponent,
    ListMultiSeamenSignOffComponent
  ],
  imports: [
    CommonModule,
    MultiSeamenSignOffRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class MultiSeamenSignOffModule { }
