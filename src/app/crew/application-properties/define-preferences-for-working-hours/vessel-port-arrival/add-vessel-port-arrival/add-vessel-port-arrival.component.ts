...
@Component({
  selector: 'app-add-vessel-port-arrival',
  templateUrl: './add-vessel-port-arrival.component.html',
  styleUrls: ['./add-vessel-port-arrival.component.sass'],
  providers: [
...
export class AddVesselPortArrivalComponent implements OnInit {
