...
import { VesselUsWaterArrivalRoutingModule } from './vessel-us-water-arrival-routing.module';
...
@NgModule({
  declarations: [
    ListVesselUsWaterArrivalComponent,
    AddVesselUsWaterArrivalComponent
  ],
  imports: [
    CommonModule,
    VesselUsWaterArrivalRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class VesselUsWaterArrivalModule { }
