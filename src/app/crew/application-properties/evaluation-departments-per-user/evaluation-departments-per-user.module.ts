...
import { EvaluationDepartmentsPerUserRoutingModule } from './evaluation-departments-per-user-routing.module';
...
@NgModule({
  declarations: [
    AddEvaluationDepartmentsPerUserComponent,
    ListEvaluationDepartmentsPerUserComponent
  ],
  providers:[
    CommonService
  ],
  imports: [
    CommonModule,
    EvaluationDepartmentsPerUserRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class EvaluationDepartmentsPerUserModule { }
