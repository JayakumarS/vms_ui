...
import { WorkLicenseRoutingModule } from './work-license-routing.module';
...
import { DeleteComponent } from './list-work-license/delete/delete.component';
...
@NgModule({
  declarations: [
    AddWorkLicenseComponent,
    ListWorkLicenseComponent,
    ViewWorkLicenseComponent,
    DeleteComponent
  ],
  imports: [
    CommonModule,
    WorkLicenseRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class WorkLicenseModule { }
