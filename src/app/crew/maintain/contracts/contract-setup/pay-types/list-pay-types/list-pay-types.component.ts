  ...
  sortData(data: payTypes[]): payTypes[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case "payType":
          [propertyA, propertyB] = [a.payType, b.payType];
          break;
          case "siNo":
            [propertyA, propertyB] = [a.siNo, b.siNo];
            break;
            case "contents":
              [propertyA, propertyB] = [a.contents, b.contents];
              break;
              ...
              case "description":
                ...
                case "pay":
                  [propertyA, propertyB] = [a.pay, b.pay];
                  break;

                  case "mga":
                    [propertyA, propertyB] = [a.mga, b.mga];
                    break;

                    case "office":
                      [propertyA, propertyB] = [a.office, b.office];
                      break;
                      case "col":
                        [propertyA, propertyB] = [a.col, b.col];
                        break;
