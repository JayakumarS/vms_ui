...
@Component({
  selector: 'app-add-travel-agencies',
  templateUrl: './add-travel-agencies.component.html',
  styleUrls: ['./add-travel-agencies.component.sass']
})
export class AddTravelAgenciesComponent  extends UnsubscribeOnDestroyAdapter  implements OnInit {
  ...
  Cancel() {
    this.router.navigate(['/crew/maintain/crew-ticketing/travel-agencies/list-travel-agencies']);
