...
import { LinkTicketTypesLedgerCardsRoutingModule } from './link-ticket-types-ledger-cards-routing.module';
...
@NgModule({
  declarations: [
    AddLinkTicketTypesLedgerCardsComponent,
    ListLinkTicketTypesLedgerCardsComponent
  ],
  providers:[
    CommonService
  ],
  imports: [
    CommonModule,
    LinkTicketTypesLedgerCardsRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class LinkTicketTypesLedgerCardsModule { }
