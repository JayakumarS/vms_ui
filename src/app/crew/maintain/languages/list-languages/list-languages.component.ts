...
@Component({
  ...
  styleUrls: ['./list-languages.component.sass']
})
export class ListLanguagesComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  public loadData() {
    this.exampleDatabase = new LanguagesService(this.httpClient,this.serverUrl,this.httpService);
