...
import { CrewVesselAssignmentRoutingModule } from './crew-vessel-assignment-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    CrewVesselAssignmentRoutingModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
    MatFormFieldModule,
...
export class CrewVesselAssignmentModule { }
