...
@Component({
  selector: 'app-list-supplier-groups',
  templateUrl: './list-supplier-groups.component.html',
  styleUrls: ['./list-supplier-groups.component.sass']
})
export class ListSupplierGroupsComponent extends UnsubscribeOnDestroyAdapter implements OnInit {
  ...
  exampleDatabase: SupplierGroupsService | null;
  selection = new SelectionModel<SupplierGroups>(true, []);
  index: number;
  id: number;
  customerMaster: SupplierGroups | null;
  permissionList: any = [];
  constructor(
  ...
  public loadData() {
    this.exampleDatabase = new SupplierGroupsService(this.httpClient, this.serverUrl, this.httpService);
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: SupplierGroups) {
...
export class ExampleDataSource extends DataSource<SupplierGroups> {
  ...
  filteredData: SupplierGroups[] = [];
  renderedData: SupplierGroups[] = [];
  constructor(
    public exampleDatabase: SupplierGroupsService,
  ...
  connect(): Observable<SupplierGroups[]> {
  ...
  sortData(data: SupplierGroups[]): SupplierGroups[] {
