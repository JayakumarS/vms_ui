...
export class SystemAndSubsystemService extends UnsubscribeOnDestroyAdapter{
  ...
  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<systemAndSubsystem[]> = new BehaviorSubject<systemAndSubsystem[]>(
    []
  );
