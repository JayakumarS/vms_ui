...
import { SystemsAndSubsystemsRoutingModule } from './systems-and-subsystems-routing.module';
...
@NgModule({
  declarations: [
    AddSystemsAndSubsystemsComponent,
    ListSystemsAndSubsystemsComponent
  ],
  imports: [
    CommonModule,
    SystemsAndSubsystemsRoutingModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
    MatPaginatorModule,
...
export class SystemsAndSubsystemsModule { }
