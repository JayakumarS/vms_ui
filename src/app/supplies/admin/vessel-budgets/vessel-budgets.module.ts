...
import { VesselBudgetsRoutingModule } from './vessel-budgets-routing.module';
...
@NgModule({
  declarations: [
    ListVesselBudgetsComponent,
    AddVesselBudgetsPopupComponent,
  ],
  providers:[
    CommonService
  ],
...
export class VesselBudgetsModule { }
