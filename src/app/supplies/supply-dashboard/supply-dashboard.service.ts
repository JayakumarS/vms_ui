...
import { supplydashboard } from './supply-dashboard/supply-dashboard.model';
const httpOptions = {
...
export class SupplyDashboardService extends UnsubscribeOnDestroyAdapter{
  ...
  isTblLoading = true;
  currencyList:[];
  dataChange: BehaviorSubject<supplydashboard[]> = new BehaviorSubject<supplydashboard[]>(
    []
  );
