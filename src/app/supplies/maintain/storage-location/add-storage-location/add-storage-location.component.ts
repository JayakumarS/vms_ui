...
@Component({
  ...
  styleUrls: ['./add-storage-location.component.sass']
})
export class AddStorageLocationComponent implements OnInit {
  ...
  update() {
    ...
    if(this.docForm.valid){
      this.StorageLocationService.updateStorageLocation(this.docForm.value, this.router, this.notificationService);
    }else{
  ...
  save(){
    if(this.docForm.valid){
      this.StorageLocationService.saveStorageLocation(this.docForm.value, this.router, this.notificationService);
    }else{
      this.matError.markFormGroupTouched(this.docForm);
      this.notificationService.showNotification(
        "snackbar-danger",
