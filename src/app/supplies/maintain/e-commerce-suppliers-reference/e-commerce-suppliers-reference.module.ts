...
@NgModule({
  declarations: [
    AddECommerceSuppliersReferenceComponent,
    ListECommerceSuppliersReferenceComponent
  ...
  imports: [
    CommonModule,
    ECommerceSuppliersReferenceRoutingModule,
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
    MatTableModule,
...
export class ECommerceSuppliersReferenceModule { }
